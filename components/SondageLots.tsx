...
const tableHeaders = [
  ...
  'DATE RECEPTION', 'RECOLTE', 'MAGASIN', 'GRADE LOT'
];
    ...
    <div className="p-6 lg:p-10 space-y-8 bg-gray-50">
      ...
      <div className="bg-white p-6 rounded-b-xl shadow-lg border">
        ...
        <div className="mt-6 pt-6 border-t bg-blue-50 p-6 rounded-lg">
          <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center"><QuestionMarkCircleIcon className="h-6 w-6 mr-2 text-blue-700"/>Décision de Sondage</h3>
          <div className="flex items-end gap-6">
            <div className="space-y-1 w-64">
              <label className="font-medium text-gray-600">Sonder ?</label>
              <select className="w-full form-select"><option>Oui</option><option>Non</option></select>
            </div>
        ...
        <div className="flex justify-end gap-4 mt-6 pt-6 border-t">
            ...
            <button className="bg-[#0d2d53] hover:bg-blue-800 text-white font-bold py-2 px-6 rounded-lg shadow-md transition-colors flex items-center gap-2"><MagnifyingGlassIcon className="h-5 w-5"/>Sonder la Sélection</button>
            <button className="bg-white hover:bg-gray-100 text-gray-700 font-bold py-2 px-6 rounded-lg border border-gray-300 shadow-sm transition-colors flex items-center gap-2"><SaveIcon className="h-5 w-5"/>Enregistrer les Résultats</button>
        </div>
      </div>
